...
public class ContatoDao implements Icrud{
    ...
    private void criarArquivoCasoNaoExista(Path caminhoDoAqruivo) throws Exception{
        try{
            File arquivo = new File(caminhoDoAqruivo.toString());
            if(!arquivo.exists()){
    ...
    public void incluir(Contato objeto) throws Exception{
        try {
            ...
            criarArquivoCasoNaoExista(caminhoDoArquivo);
