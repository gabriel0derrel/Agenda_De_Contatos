...
public class MainUI extends javax.swing.JFrame {
    ...
    private void jButton3_consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3_consultarActionPerformed
        ...
        if(consultarHasBeenClicked){
            ...
            jTextField1_Nome.getDocument().addDocumentListener(new DocumentListener() {
                @Override
                ...
                private void filterTable() {
                    String text = jTextField1_Nome.getText();
                    if (text.trim().length() == 0) {
                        object.setRowFilter(null);
                    } else {
                        object.setRowFilter(RowFilter.regexFilter("(?i)" + Pattern.quote(text), 0));
                    }
                }
            });
